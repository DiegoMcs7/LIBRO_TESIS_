...
\usepackage{amsfonts}
\usepackage{csquotes}
\usepackage[spanish]{babel} % Bibliography
\usepackage[backend=biber,style=numeric,sorting=none,maxbibnames=99]{biblatex} % Bibliography
...
% ----------------------------
\title{Dinámica de los Precios en el Sector de Materiales de Construcción: Patrones y Predicciones Basados en Datos}
\author{Diego Milciades Espínola Alvarenga}
\date{October 2025}

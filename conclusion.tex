...
\justify
En cuanto a los resultados cuantitativos, el modelo LSTM resultó más preciso para el cemento (RMSE de prueba de Gs.~4.394,96 en ambos escenarios), mientras que para el ladrillo, cuya serie presentó precios prácticamente constantes durante el período de evaluación, el modelo SARIMAX fue más preciso (Gs.~4,55 frente a Gs.~6,62 de la LSTM bidireccional). El modelo LSTM para el nivel del río Paraguay, utilizado como variable exógena, alcanzó un RMSE de 0,0457~m, equivalente a menos de 5~cm de error sobre una serie con un rango de casi 10~metros. Estos resultados ilustran que la elección del modelo óptimo depende de las características específicas de la serie a predecir: modelos más complejos no garantizan mayor precisión en todos los contextos.

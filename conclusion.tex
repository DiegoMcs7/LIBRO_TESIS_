...
\justify
En cuanto a los resultados cuantitativos, el modelo LSTM resultó más preciso para el cemento (RMSE de prueba de Gs.~4.394,96 en el escenario con pandemia), mientras que para el ladrillo, cuya serie presentó precios prácticamente constantes durante el período de evaluación, el modelo SARIMAX fue más preciso (Gs.~4,54 frente a Gs.~6,22 de la LSTM bidireccional). El modelo LSTM para el nivel del río Paraguay, utilizado como variable exógena, alcanzó un NSE de 0,9992 con un RMSE de 0,0449~m. Estos resultados ilustran que la elección del modelo óptimo depende de las características específicas de la serie a predecir: modelos más complejos no garantizan mayor precisión en todos los contextos.

...
\justify
Un segundo vacío en la literatura regional es el tratamiento de variables externas. El nivel del río Paraguay y los períodos de restricción sanitaria afectan directamente la logística de abastecimiento y la disponibilidad de materiales de construcción, pero pocas investigaciones los incorporan de forma explícita en los modelos de predicción de precios. Incluirlos no responde a una preferencia metodológica: es consecuencia de que los precios en Paraguay están condicionados por factores geográficos e institucionales que no pueden ignorarse sin comprometer la validez del modelo.

...
\justify
La búsqueda de hiperparámetros se realizó con Optuna, usando el sampler TPE (\textit{Tree-structured Parzen Estimator}) y poda de trials con \textit{MedianPruner} para descartar tempranamente las configuraciones claramente inferiores. Se evaluaron 300 trials en Kaggle con dos GPUs Tesla T4 bajo la estrategia \texttt{MirroredStrategy}, proceso que demandó 278 minutos en total. El mejor RMSE de validación obtenido fue de 0,0371 m.
...
\justify
Dado que el modelo emplea una estrategia recursiva unistep, cada predicción corresponde a un único paso adelante ($t+1$). La Figura \ref{fig:rmse_por_paso} ilustra este punto de evaluación en el conjunto de prueba, con un RMSE de 0,0457 m.
...
\justify
El histograma muestra una distribución aproximadamente centrada en cero, sin sesgo sistemático apreciable. La mayor parte de los errores se concentra en un intervalo estrecho alrededor del origen, con una leve asimetría positiva que indica que el modelo tiende a subestimar el nivel en algunos periodos. El gráfico Q-Q muestra que los residuos se aproximan razonablemente a una distribución normal, con desviaciones en las colas que corresponden a eventos hidrológicos extremos de difícil predicción.

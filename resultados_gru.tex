...
\justify
El test de Ljung-Box sobre los residuos del conjunto de prueba arroja un $p$-valor de 0,011 a 10 rezagos (rechaza $H_0$) y de 0,119 a 20 rezagos (no rechaza $H_0$), valores idénticos a los del escenario sin pandemia. Este resultado mixto es esperable, dado que la búsqueda de Optuna convergió a la misma configuración en ambos escenarios. La autocorrelación a 10 rezagos indica cierta estructura temporal residual de corto plazo que el modelo no logra absorber completamente.

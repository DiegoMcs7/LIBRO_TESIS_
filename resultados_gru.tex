...
\justify
El modelo GRU proyecta, bajo el escenario sin pandemia, un rango de precios del cemento de Gs.~59.915 a Gs.~63.852 a lo largo del horizonte de 24 meses. La proyección muestra una trayectoria relativamente estable, dentro de una banda contenida respecto al nivel histórico reciente.
...
\justify
Para el escenario con efecto pandémico, la búsqueda con Optuna (261 ensayos, 151,75 min) convergió a la misma configuración que el escenario sin pandemia: una capa GRU unidireccional con 64 unidades ocultas, ventana de entrada (\textit{lookback}) de 4 meses, optimizador AdamW con tasa de aprendizaje $\eta = 0{,}006946$ y \textit{weight decay} de $2{,}26 \times 10^{-4}$, \textit{batch size} de 8, \textit{dropout} de 0{,}1, \textit{dropout} recurrente de 0{,}1 y \textit{scheduler} ReduceLROnPlateau. Los 13.889 parámetros entrenables son idénticos al escenario sin pandemia. La Tabla~\ref{tab:gru_cemento_cc_arq} resume estos parámetros.
...
\justify
Bajo el escenario con efecto pandémico, el modelo GRU proyecta para el cemento un rango de precios de Gs.~59.915 a Gs.~65.337 a lo largo del horizonte de 24 meses. Esta proyección es levemente superior al límite máximo del escenario sin pandemia (Gs.~63.852), lo que sugiere que la variable pandémica empuja marginalmente los precios al alza en el largo plazo según la interpretación del modelo. La diferencia entre escenarios es acotada, lo que indica que el GRU capturó el efecto pandémico sobre el cemento como un factor de impacto moderado.
